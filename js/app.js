...
let allEnemies = [];
let enemy = new Enemy(0, 60, randomEnemyMovement(100, 200));
let enemy1 = new Enemy(0, 140, randomEnemyMovement(200, 300));
let enemy2 = new Enemy(0, 220, randomEnemyMovement(300, 400));
